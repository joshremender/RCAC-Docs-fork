help([[
        This module file loads Ansys 2026R1 (2026.1; v261).
...
local version = "2026R1"
local app = "ansys"
local contact = "rcac-help"
local license_type = "proprietary"
local ansysdir = "/apps/external/apps/ansys/2026r1/ansys_inc"
local modroot = ansysdir.."/v261"
