...
Example script to showcase submitting your first job.
Link to the jobs.md page for more comprehensive data.

## Helpful Scripts

A small list of helpful scripts for people to see their information